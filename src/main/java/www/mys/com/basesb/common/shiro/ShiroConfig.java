...
import www.mys.com.basesb.common.auth.AuthRealm;
import www.mys.com.basesb.common.auth.CredentialsMatcher;
import www.mys.com.basesb.common.auth.ShrioRedisCacheManager;
import www.mys.com.basesb.mapper.RedisSessionDAO;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager manager) {
        ...
        filterChainDefinitionMap.put("/api/df/info/**", "authc");
        filterChainDefinitionMap.put("/api/df/keepAccount/**", "authc");
        filterChainDefinitionMap.put("/api/dy/info/**", "authc");
