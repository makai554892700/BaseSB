...
public interface TextsMapper extends JpaRepository<Texts, Integer> {
    ...
    @Query(value = "select new www.mys.com.basesb.vo.response.ResponseText(t.id,t.textType,t.textValue,t.groupName" +
    ...
    @Query(value = "select new www.mys.com.basesb.pojo.Texts(t.id,t.textType,t.textValue,t.groupName,t.groupMD5" +
