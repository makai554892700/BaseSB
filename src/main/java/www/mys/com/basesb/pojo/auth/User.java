package www.mys.com.basesb.pojo.auth;

import www.mys.com.basesb.utils.net.TimeUtils;
...
@Entity
@Table(uniqueConstraints = {@UniqueConstraint(columnNames = {"userName", "packageName"})}
        , indexes = {@Index(columnList = "createdMark")})
public class User {
    ...
    public User(String userName, String nickName, Integer sex, String userDesc, String email
            , String phone, String photo, String backPhoto, String packageName
            , Integer zone, Date lastLoginTime, boolean available) {
