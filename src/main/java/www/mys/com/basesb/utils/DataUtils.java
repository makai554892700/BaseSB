...
import www.mys.com.basesb.pojo.auth.SessionUser;
import www.mys.com.basesb.pojo.auth.User;
import www.mys.com.basesb.utils.net.HexUtils;
...
public class DataUtils {
    ...
    public static User userRequest2User(UserRequest userRequest, String packageName) {
        ...
        return new User(userRequest.getUserName(), userRequest.getNickName()
                ...
                , userRequest.getPhone(), userRequest.getImgUrl(), userRequest.getBackImgUrl()
                , packageName, userRequest.getZone(), new Date(), userRequest.isAvailable());
    }
